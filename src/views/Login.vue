      ...
      <form @submit.prevent="login" class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <router-link to="/forgot-password" class="font-semibold text-blue-600 hover:text-blue-500">Forgot password?</router-link>
            </div>
          </div>
          <div class="mt-2">
